...
> **Status (2026-05-04):** Lanes A + B fully shipped (19 commits, `2a112e1..477a929`). Lane C decisions all resolved. See "Shipped" section below for commit map.
...
**A1. Cut EL, ship 7 competitions.** ✅ `1de9436`
...
**A2. Worker cron at 60s + visible freshness timestamps.** ✅ `3d4103e`
...
**A8. Stat leaders: assists, clean sheets, cards.** ✅ `30489a3`
...
**B1. Phase-aware home page (replaces globe).** ✅ `1de9436`
...
**B2. Pool Pulse — real-time pool activity stream.** ✅ `9ad737b`
...
**B3. Confidence-as-currency.** ✅ `33d83cf`
...
**B4. Cinematic points reveal.** ✅ `a9800c1`
...
**B6. Wall of Fame / Shame weekly auto-card.** ✅ `477a929`
...
## Lane C — Decisions ✅ (resolved)

**C1. EL or EC for the 8th slot?** → **Dropped entirely.** Ship 7 competitions that work.
**C2. WC national-squad data — source or skip?** → **Skipped.** Placeholder until late-May squad announcements.
**C3. Auth: anonymous-first or sign-up-first?** → **Anonymous-first.** Sign-up prompt after 3 picks.
**C4. Globe — kill immediately or stage replacement?** → **Killed.** Replaced with phase-aware hero (B1).
